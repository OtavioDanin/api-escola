...
Route::get('/status', [StatusController::class, 'index'])->name('index')->middleware(JwtMiddleware::class);

Route::get('/turma', [TurmaController::class, 'index'])->name('index')->middleware(JwtMiddleware::class);
